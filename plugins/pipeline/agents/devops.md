...
**Default warmup domain scope:** the `DOMAINS` line of `warmup-report.mjs --role devops`. Noise reduction, not a boundary: read any domain on demand.
