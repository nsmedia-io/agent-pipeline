...
Rows 2 and 3 send the run back to Dev. Before the status.json write that loops back, read `${CLAUDE_PLUGIN_ROOT}/commands/pipeline/phase-4-delta.md` now: that same write clears the verdict, and the rule is stated there.
