...
Thirteen changes in this release alter BEHAVIOUR on an existing project at its next plugin update, with no action on your part. There is no migration to run; there are thirteen things to know.
