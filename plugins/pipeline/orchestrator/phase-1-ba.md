...
Route: `next-phase.mjs --status "$PIPELINE_BASE/<issue>/status.json" --spec "$PIPELINE_BASE/<issue>/spec.json"` prints the next phase and its files (see "How this command loads").
